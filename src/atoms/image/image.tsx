...
export const Image = ({
  ...
  switch (layout) {
    case "fixed-height":
      return <amp-img src={path} width={"auto"} height={height} layout={"fixed-height"} {...rest}></amp-img>;
    case "fixed":
      return <amp-img src={path} width={width} height={height} layout={"fixed"} {...rest}></amp-img>;
    default:
      return (
        <amp-img
          src={path}
