...
export const DailyMotionElementBase = ({
  ...
  return config.opts && config.opts.storyElementRender && config.opts.storyElementRender.dailyMotionRender ? (
    config.opts.storyElementRender.dailyMotionRender({ story, config })
  ) : (
